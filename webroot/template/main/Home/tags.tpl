		...
		<div class="container">
			<div class="review-search-slider-section row justify-content-center">
                <div class="col-12 col-lg-12">
                    <h1 class="review-slider-title">{$_RESULTS_FOR} {$term}</h1>
                    <p class="review-slider-subtitle"><span class="badge badge-secondary">{$n_tags} {$_PRODUCTS}</span></p>
                </div>
                        ...
                        <div class="col-12">
                            <div class="filter row">
                                <div class="col-8 col-md-3">
                                    <h6 class="result">{$_SHOWING_ALL} <span class="badge badge-secondary">{$n_tags}</span> {$_RESULTS}</h6>
                                </div>
