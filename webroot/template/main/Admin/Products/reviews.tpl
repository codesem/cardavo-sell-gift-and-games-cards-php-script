     ...
     <form class="form-vertical" method="GET">
           <div class="form-group">
             ...
             <select name="search" class="form-control">
               <option value="id" {if $search == "id"}selected{/if}>Review ID</option>
                                     ...
                                     <div class="table-responsive">
                                                    <table class="table m-0">
                                                        ...
                                                        <thead class="thead-light">
                                                            <tr>
                                                                ...
                                                                <th><i class="fa fa-star"></i> Stars</th>
	                                           ...
	                                           {foreach from=$reviews item=foo}
                                                            <tr>
                                                                ...
                                                                <td title="{$foo['fullreview']}">{$foo['review']}</td>
                                                                                                                                <td>
                                               {if $foo['status'] == 'on'}
                                               ...
                                               {/if}</td>
                                                                <td><span class="badge badge-warning">{$foo['stars']}</span></td>
                                                                <td><a href="{$foo['link']}/reviews" target="_blank">
