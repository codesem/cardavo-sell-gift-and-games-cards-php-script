 {include file='../Layout/header.tpl'}
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                               <div class="card-box">
     {if $modify}<div class='alert alert-success'>Price Updated Successfully</div>{/if}
     {if $deactivated}<div class='alert alert-success'>Price Deactivated Successfully</div>{/if}
     {if $activated}<div class='alert alert-success'>Price Activated Successfully</div>{/if}
     {if $deleted}<div class="alert alert-success">Price Deleted Successfully</div>{/if}
     ...
     {include file='../Products/menu.tpl'}
                                     <div class="table-responsive">
                                               ...
                                               {/if}</td>
                                                                <td>{$foo['ago']}</td>
                                                                <td>
                                                                    <a href="{$ADM}prices/edit/{$foo['id']}/" class="badge badge-info">
